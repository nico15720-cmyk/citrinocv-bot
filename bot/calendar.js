...
// ============================================================
const HORARIOS = {
  1: { dia: "Lunes",     franjas: [{ inicio: 9, fin: 20 }] },           // lunes todo el día
  2: { dia: "Martes",    franjas: [{ inicio: 9, fin: 13 }] },           // martes mañana
  3: { dia: "Miércoles", franjas: [{ inicio: 14, fin: 20 }] },          // miércoles tarde
  4: { dia: "Jueves",    franjas: [{ inicio: 9, fin: 13 }] },           // jueves mañana
  5: { dia: "Viernes",   franjas: [{ inicio: 9, fin: 20 }] },           // viernes todo el día
  6: { dia: "Sábado",    franjas: [{ inicio: 9, fin: 13 }] },           // sábado mañana
